    ...
    return Scaffold(
      ...
      body: Container(
        color: Color.fromARGB(
            255, 1, 253, 135), // Change the background color to black
        child: Column(
          children: [
            SizedBox(height: 30),
            Text(
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                    ...
                    color: Color.fromARGB(120, 245, 4, 4)),
              ),
            ),
            Padding(
              padding: const EdgeInsets.all(15.0),
            ...
            Text(
              ...
              style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                  color: const Color.fromARGB(255, 16, 29, 27)),
            ),
            SizedBox(height: 8),
            IconButton(
              icon: Icon(Icons.share, color: Color.fromARGB(255, 65, 4, 49)),
